...
class Factory
{
    ...
    /**
         * Factory for Finding Aid tab plugin.
    ...
    */
    public static function getArchivesSpace(ServiceManager $sm)
    {
         return new \VuFind\RecordTab\ArchivesSpace($sm->getServiceLocator()->get('Vufind\ArchivesSpaceConnection'));
    }
